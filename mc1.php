...
<form class="row" action="php/calcular_mc1.php" method="post">
    <div class="card-body p-3 row">
        ...
        <div class="mt-3 col-sm-3">
            ...
            <input name="volume_tratado" type="number" class="form-control">
        </div>
        <div class="mt-3 col-sm-4">
            ...
            <option selected>Selecione o tipo de versão</option>
            <option value="alvo1">Alvo 1</option>
            <option value="alvo2">Alvo 2</option>
          </select>
        </div>
        <div class="mt-3 col-sm-4">
        ...
        <div class="mt-3 col-sm-4">
            <label class="form-label">Número da condição</label>
